...
void scene1(World &world, PerspectiveCamera &perspectiveCamera, int32_t height, int32_t width){
    ...
    std::shared_ptr<CheckerTexture> checker = std::make_shared<CheckerTexture>(0.32, vec3(0.2, 0.3, 0.1), vec3(0.9, 0.9, 0.9));
    ...
    // std::shared_ptr<Material> material3 = std::make_shared<Metal>(vec3(0.1, 0.6, 0.1), 0.0);
